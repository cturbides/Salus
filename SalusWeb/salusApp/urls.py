...
urlpatterns = [
    ...
    path('menu-principal/mi-clinica/room/<str:room_uuid>', views.show_clinic_room, name='mi-clinica-room'),
    path('menu-principal/mi-clinica/room/<str:room_uuid>/delete', views.delete_room, name='room-delete'),
    path('menu-principal/mi-clinica/room/<str:room_uuid>/edit', views.edit_room, name='room-edit'),
    ...
    path('menu-principal/equipo/enfermeros/eliminar/<str:nurse_uuid>', views.delete_nurses, name='enfermeros-delete'),
    path('menu-principal/equipo/enfermeros/editar/<str:nurse_uuid>', views.update_nurses, name='enfermeros-edit'),
    ...
    path('menu-principal/equipo/doctores/eliminar/<str:doctor_uuid>', views.delete_doctor, name='doctores-delete'),
    path('menu-principal/equipo/doctores/editar/<str:doctor_uuid>', views.update_doctor, name='doctores-edit'),
    ...
    path('menu-principal/equipo/pacientes/editar/<str:patient_uuid>', views.update_patient, name='pacientes-edit'),
    path('menu-principal/equipo/pacientes/eliminar/<str:patient_uuid>', views.delete_patient, name='pacientes-delete'),
